...
class SimpleTransformer:
    ...
    def forward(self, input_ids: list[list[int]], targets: list[list[int]] | None = None) -> tuple[list[list[list[float]]], dict]:
        """
    ...
    def train_step(self, input_ids: list[list[int]], target_ids: list[list[int]], learning_rate: float | None = None) -> float:
        """
