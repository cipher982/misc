...
from transformerlab.viz.plots import plot_loss_history, plot_layer_statistics
...
def demo_basic_training():
    ...
    # Test configurations
    configs = [
        {"name": "LayerNorm + ReLU", "norm": "LayerNorm", "activation": "ReLU", "residual": "Pre-LN"},
        {"name": "RMSNorm + GeLU", "norm": "RMSNorm", "activation": "GeLU", "residual": "Pre-LN"},
        {"name": "No Norm + Swish", "norm": "None", "activation": "Swish", "residual": "Post-LN"},
    ]
...
def demo_visualization():
    ...
    if layer_stats_history:
        ...
        fig = plot_layer_statistics(last_layer_stats, 'attention_weights_mean', 
